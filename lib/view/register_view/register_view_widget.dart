...
import 'package:http/http.dart' as http; // Importar la biblioteca http
  ...
  void _register() async {
    ...
    if (success) {
      setState(() {
        ...
        SnackbarMessages.showPositiveSnackbar(context, "Registro exitoso");
      });
      context.pushNamed("MainMenu");
    } else {
      setState(() {
        _message = "Failed to register. Please try again.";
        SnackbarMessages.showNegativeSnackbar(context, "Fallo en el registro");
      });
    }
