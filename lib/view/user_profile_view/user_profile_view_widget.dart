...
class _UserProfileViewWidgetState extends State<UserProfileViewWidget> {
  ...
  Future<bool> _confirmDeletion(int userId) async {
                              ...
                              children: [
                                        ...
                                        child: Switch(
                                          ...
                                          onChanged: (bool value) async {
                                            ...
                                            if (!success) {
                                              ...
                                              SnackbarMessages.showNegativeSnackbar(
                                                  context,
                                                  "Error al actualizar estado de admin");
                                            } else {
                                              SnackbarMessages.showPositiveSnackbar(
                                                  context,
                                                  "Estado de admin actualizado con éxito");
                                            }
                                          },
                                ...
                                Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () {
                                      if (_user != null) {
                                        context.pushNamed('UserRecipesView',
                                            queryParameters: {
                                        ...
                                        SnackbarMessages.showNegativeSnackbar(
                                            context,
                                            "Este usuario no tiene recetas agregadas");
                                      }
                                    },
                                    text: 'Ver Recetas',
                                                      ...
                                                      if (success) {
                                                        ...
                                                        SnackbarMessages
                                                            .showPositiveSnackbar(
                                                                context,
                                                                "Bio actualizado con éxito");
                                                      } else {
                                                        SnackbarMessages
                                                            .showNegativeSnackbar(
                                                                context,
                                                                "Error al actualizar bio");
                                                      }
                                                    },
                                                  ),
                                                ],
